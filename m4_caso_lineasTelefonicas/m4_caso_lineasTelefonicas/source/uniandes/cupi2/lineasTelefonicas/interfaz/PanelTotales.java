...
public class PanelTotales extends JPanel
{
    ...
    {
        etiquetaCosto.setText( formatearValor( empresa.darTotalCostoLlamadasDesdeLineasNoAlternativas( ) ) );
        etiquetaNumeroLlamadas.setText( "Total Llamadas: " + formatearValorEntero( empresa.darTotalNumeroLlamadasDesdeLineasNoAlternativas( ) ) );
        etiquetaMinutos.setText( "Total de Minutos: " + formatearValorEntero( empresa.darTotalMinutosDesdeLineasNoAlternativas( ) ) );
        if( !Double.isNaN( empresa.darCostoPromedioMinutoDesdeLineasNoAlternativas( ) ) )
        {
            etiquetaCostoPromedio.setText( "Costo promedio por minuto: " + formatearValor( empresa.darCostoPromedioMinutoDesdeLineasNoAlternativas( ) ) );
        }
        else
        {
