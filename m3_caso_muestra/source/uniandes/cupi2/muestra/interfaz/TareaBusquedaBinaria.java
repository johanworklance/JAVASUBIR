/** ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * $Id: TareaBusquedaBinaria.java,v 1.6 2006/08/06 20:26:47 da-romer Exp $
 ...
 */
public class TareaBusquedaBinaria extends Thread
{
    // -----------------------------------------------------------------
    // Atributos
    // -----------------------------------------------------------------
     ...
     */
    private MuestraOrdenada muestra;
     ...
     */
    public TareaBusquedaBinaria( MuestraOrdenada laMuestra, InterfazMuestra ventanaPrincipal )
    {
        muestra = laMuestra;
    ...
    public void run( )
    {
        ...
        for( int i = 0; i < muestra.darTamanio( ); i++ )
        {
            ...
            muestra.buscarBinario( i );
            long t2 = System.currentTimeMillis( );
            tiempoTotal += ( t2 - t1 );
        }

        principal.registrarTiempoBusquedaBinaria( ( double )tiempoTotal / ( double )muestra.darTamanio( ) );
    }
}
