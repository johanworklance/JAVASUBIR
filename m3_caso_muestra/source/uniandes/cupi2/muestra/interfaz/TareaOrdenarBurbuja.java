/** ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * $Id: TareaOrdenarBurbuja.java,v 1.6 2006/08/16 05:44:48 f-vela Exp $
...
/**
 * Esta tarea se usa para ordenar una muestra usando el algoritmo de Burbuja
 */
public class TareaOrdenarBurbuja extends Thread
{
    // -----------------------------------------------------------------
    // Atributos
    // -----------------------------------------------------------------
     ...
     */
    public TareaOrdenarBurbuja( Muestra laMuestra, InterfazMuestra ventanaPrincipal )
    {
        muestra = laMuestra;
    ...
    public void run( )
    {
        ...
        principal.registrarTiempoOrdenamientoBurbuja( tiempoTotal );
