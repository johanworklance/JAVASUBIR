 ...
 */
public class PanelTotalesLineasAlternativas extends JPanel
{
     ...
     */
    public PanelTotalesLineasAlternativas( )
    {
        ...
        etiquetaCosto.setFont( new Font( "Tahoma", Font.BOLD, 34 ) );
        ...
        posicion = new GridBagConstraints( 2, 19, 1, 1, 1, 1, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets( 5, 5, 30, 30 ), 0, 0 );
    ...
    {
        etiquetaCosto.setText( formatearValor( empresa.darTotalCostoLlamadasDesdeLineasAlternativas() ) );
        etiquetaNumeroLlamadas.setText( "Total llamadas: " + formatearValorEntero( empresa.darTotalNumeroLlamadasDesdeLineasAlternativas( ) ) );
        etiquetaMinutos.setText( "Total de minutos: " + formatearValorEntero( empresa.darTotalMinutosDesdeLineasAlternativas( ) ) );
        if( !Double.isNaN( empresa.darCostoPromedioMinutoDesdeLineasAlternativas( ) ) )
        {
            etiquetaCostoPromedio.setText( "Costo promedio por minuto: " + formatearValor( empresa.darCostoPromedioMinutoDesdeLineasAlternativas( ) ) );
        }
        else
        {
