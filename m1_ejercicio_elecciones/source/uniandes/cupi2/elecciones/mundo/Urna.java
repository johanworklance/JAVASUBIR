...
public class Urna
{
  ...
  //TODO Declare el atributo de candidato2
    ...
    {
    	//TODO Complete el m�todo seg�n la documentaci�n.
    	double votosTotalesInternet= candidato1.darVotosInfluenciaInternet()+candidato2.darVotosInfluenciaInternet()+candidato3.darVotosInfluenciaInternet();
    	double porcentaje= candidato1.darVotosInfluenciaInternet()/votosTotalesInternet * 100;
    	return porcentaje;
    }
    ...
    public double calcularPorcentajeVotosPorInternetCandidato2( )
    {
    	//TODO Complete el m�todo seg�n la documentaci�n.
    	double votosTotalesInternet= candidato1.darVotosInfluenciaInternet()+candidato2.darVotosInfluenciaInternet()+candidato3.darVotosInfluenciaInternet();
    	double porcentaje= candidato2.darVotosInfluenciaInternet()/votosTotalesInternet * 100;
    	return porcentaje;
    }
    ...
    public double calcularPorcentajeVotosPorInternetCandidato3( )
    {
    	...
    	double porcentaje= candidato3.darVotosInfluenciaInternet()/votosTotalesInternet * 100;
    	return porcentaje;
    }
